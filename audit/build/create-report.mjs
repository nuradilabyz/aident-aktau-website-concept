...
const sheets = [
  ...
  },
  {
    ...
    rows: [["Предварительный одностраничный сайт на подтверждённых данных", "Белый/чёрный из официального логотипа", "HTML, CSS, JavaScript", "https://github.com/nuradilabyz/aident-aktau-website-concept", "https://nuradilabyz.github.io/aident-aktau-website-concept/", "GitHub Pages через GitHub Actions", "14.07.2026", "Опубликован; noindex, nofollow и запрет в robots.txt сохранены до согласования владельцем. WhatsApp и график не опубликованы из-за расхождения источников."]],
  },
  {
    name: "QA Report",
  ...
  },
  {
    ...
    rows: [["Aident", "+7 775 825 52 43", "Не отправлять до подтверждения номера", "https://www.instagram.com/aident_clinic/", "https://nuradilabyz.github.io/aident-aktau-website-concept/", "Здравствуйте, команда Aident! Подготовил предварительную концепцию сайта для вашей цифровой стоматологии в Актау — с акцентом на коронки, CAD/CAM и 3D-моделирование: https://nuradilabyz.github.io/aident-aktau-website-concept/ Буду рад показать проект и обсудить правки.", "Здравствуйте! Подготовил концепцию сайта для Aident с акцентом на цифровые направления. Посмотреть: https://nuradilabyz.github.io/aident-aktau-website-concept/ Могу коротко показать идею и обсудить правки.", "Здравствуйте! Я подготовил предварительную концепцию сайта Aident на основе 2GIS и официального Instagram. Можно показать ссылку и обсудить, что важно оставить или изменить?", "Понимаю. Проект ни к чему не обязывает: он показывает, как объединить контакты, 2GIS и цифровые направления клиники. Если сейчас неактуально, можно сохранить ссылку на будущее.", "Не отправлять самостоятельно; WhatsApp и график требуют подтверждения владельцем"]],
  },
];
